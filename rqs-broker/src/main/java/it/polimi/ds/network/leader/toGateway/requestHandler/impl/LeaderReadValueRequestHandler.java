...
public class LeaderReadValueRequestHandler implements LeaderRequestHandler {
    private final Logger log = Logger.getLogger(LeaderReadValueRequestHandler.class.getName());
